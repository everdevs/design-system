...
import { Accordion, AccordionPops } from "@evernest/accordion";

const WrappedAccordion: React.FC<AccordionPops> = (props) => <Wrapper><Accordion {...props}/></Wrapper>
...
import { Button, ButtonPops } from "@evernest/button";

const ThemedButton = withTheme<ButtonPops>(Button, theme)
